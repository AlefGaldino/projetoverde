...
automacao 2 -  quando o carrinho quebra, ele tem que digitar caixa, onde ele é teletransportado para o caixa e acessar o site
...
player.onChat("caixa", function () {
    ...
    player.say("💳 Resolva o pagamento para conseguir outro carrinho!")
})

======================================================================================================================

Automação 3 - onde o jogador digita o nome da localização e ele é teletransportado de acordo com a coordenada 
